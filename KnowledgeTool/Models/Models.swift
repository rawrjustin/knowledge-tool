...
// MARK: - Speaker Dialogue Examples
struct SpeakerDialogueExamples: Identifiable, Codable {
    let id: UUID
    let speaker: String
    let examples: [String]
...
struct Summary: Identifiable, Codable {
    ...
    let sourceURL: String?
    let title: String?
    let speakerDialogueExamples: [SpeakerDialogueExamples]?
    ...
    init(
        ...
        sourceURL: String? = nil,
        title: String? = nil,
        speakerDialogueExamples: [SpeakerDialogueExamples]? = nil
    ) {
        self.id = id
        self.text = text
        self.createdAt = createdAt
        ...
        self.sourceURL = sourceURL
        self.title = title
        self.speakerDialogueExamples = speakerDialogueExamples
    }
}
...
struct VideoInfo: Codable {
    ...
    init(id: String, title: String, duration: TimeInterval? = nil, thumbnailURL: String? = nil, description: String? = nil) {
        self.id = id
        self.title = title
