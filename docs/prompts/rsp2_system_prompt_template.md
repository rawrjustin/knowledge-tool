# RSP2 (Roleplay System Prompt 2) — Template

This is a roleplay system prompt template with built-in co-creation tools, memory/lore guidance, and anti-assistant best practices. It is designed to work with persona documents that include protocols, phases, and non-ending mechanics.
